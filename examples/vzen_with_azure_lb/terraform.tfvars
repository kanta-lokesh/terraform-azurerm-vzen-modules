...
# Eg: { Product : "VZEN" ,Type : "Cluster", Vendor : "Zscaler" }                                                     #
######################################################################################################################

# user_defined_tags                        = { Product : "VZEN" ,Type : "Cluster", Vendor : "Zscaler" }
...
######################################################################################################################
# Please Enter azure LB port for health monitoring   Eg: 80                                                          #
######################################################################################################################
